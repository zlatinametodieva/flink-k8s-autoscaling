...
public class Run {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        if (args.length != 10) {
            throw new IllegalStateException("Required Command line argument: jobName brokerList consumerTopic producerTopic partitions checkpointInterval windowType windowSize applyJoin applyAggregate");
        }
        ...
        String windowType = args[6];
        long windowSize = Long.parseLong(args[7]);                  // IN MILLISECONDS
        boolean applyJoin = Boolean.parseBoolean(args[8]);
        boolean applyAggregate = Boolean.parseBoolean(args[9]);
        ...
        DataStream<Tuple3<String, String, Long>> viewStream = env
                .fromSource(source, WatermarkStrategy
                                ...
                                .withIdleness(Duration.ofSeconds(10)), // TODO redundant?
                        "DeserializeBoltViewStream")
                .setParallelism(partitions)    // TODO Kafka partitions
